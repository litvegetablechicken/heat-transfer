...
G  = 289.0;
G_ex = 211.0; 
NzL = 100+1;          % Liquid 段网格数
NzSA = 100+1;          % sub_annular 段网格数
...
Tw_d0  = Tw_guess * ones(Nz,1);
Tw_do0 = Tw_guess * ones(Nz,1);

L_L0 = 0.05;           % Liquid 段初猜长度
L_SA0 = 0.25;           % sub_annular 段初猜长度

x0 = [Tw_d0; Tw_do0; L_L0; L_SA0];
...
[xsol,~,exitflag,output] = fsolve(@(x) double_pipe(x,param), x0, opts);
